...
export default function Header({ activeCategory = null }: { activeCategory?: Category | null }) {
  const [menuOpen, setMenuOpen] = useState(false)
  return <header>
    <div className="utility-bar"><span>Montag, 13. Juli 2026</span><span className="edition">Morgenausgabe · Zürich</span><a className="search-trigger" href="#nachrichten">Nachrichten finden</a></div>
